        ...
        <div className="flex flex-col items-center">
          <div className="text-center">
            <p className="text-lg font-medium text-white font-pj">
              What people have said their expereices with us
            </p>
          ...
          <div className="relative mt-10 md:mt-24 md:order-2">
            ...
            <div className="relative grid max-w-lg grid-cols-1 gap-6 mx-auto md:max-w-none lg:gap-10 md:grid-cols-3">
              <div className="flex flex-col overflow-hidden shadow-xl">
                <div className="flex flex-col justify-between flex-1 p-6 bg-black lg:py-8 lg:px-7">
                  <div className="flex-1">
                    ...
                    <blockquote className="flex-1 mt-8">
                      <p className="text-lg leading-relaxed text-gray-100 font-pj">
                        “You made it so simple. My new site is so much faster
                        and easier to work with than my old site. I have received a lot of traffic on website.”
                      </p>
                    </blockquote>
                  </div>
                  ...
                  <div className="flex-1">
                    ...
                    <blockquote className="flex-1 mt-8">
                      <p className="text-lg leading-relaxed text-gray-100 font-pj">
                        ...
                        page after getting Omega. It was whole new  expereice to work with new website.”
                      </p>
                    </blockquote>
                  </div>
